...
It is estimated that more than 200 million women and girls have undergone female genital cutting (FGC), mostly in Africa and the Middle East \cite{UNFPA14, UNIC16} \cf{updated Sep 18}.  The United Nations has declared that FGC as violates human rights, and promoted the abandonment of the practice  \cite{}.  Current progress of in reducing FGC is insufficient to keep up with the population growth, and girls and women undergoing FGC will rise significantly over the next 15 years if the trends continue \cite{UNIC16} (also see
http://www.who.int/mediacentre/factsheets/fs241/en/ updated Sep, 18) \jdcmt{This claim is surprising, and the sources are not
academic.}\cf{UN is supposed to be reliable and often quoted by academic papers}. \jdcmt{Not all UN sources are the same. The factsheet does not even seem to say that.} Breaking with the tradition can be salvaging even after migration \cite{CreiSamu19, PariSaru18, WahlJohn17a}.  FGC is also known as female genital mutilation and female circumcision;
