...
\includegraphics[scale= 0.7, page=1]{./git_push/futurefgc_full.isoplots.Rout.pdf}
\includegraphics[scale=0.7,page=2]{./git_push/futurefgc_full.isoplots.Rout.pdf}
\includegraphics[scale=0.7,page=1]{./git_push/daughterfgc_full.isoplots.Rout.pdf}
\includegraphics[scale=0.7,page=2]{./git_push/daughterfgc_full.isoplots.Rout.pdf}
\includegraphics[scale=0.7,page=1]{./git_push/futurefgcDau_full.isoplots.Rout.pdf}
\includegraphics[scale=0.7,page=2]{./git_push/futurefgcDau_full.isoplots.Rout.pdf}
...
%There is a wide range of gender theories on FGC (see\cite{Anti13, Hodg11, Lewi95}) and woman's empowerment on making FGC decision are shared concerns: for example, from social position \cite{VanMeek15}, autonomy \cite{Meye00}, gender equality and human rights \cite{Drol11}, to gender identity \cite{Youn04, Koom14, WintKoom09}…..Modernization theory proposed that, for example, education and \cite{BoylMcMo02, Youn02} can contribute to the reduction of FGC practice.  
