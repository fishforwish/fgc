...
Meye00, PariSaru18, Shel01} (and is adapted by Tostan (http://www.tostan.org/)) \jd{How do you see the Tostan fitting in? Or is that a cfonly thing?. 
...
\cfcmt{FGC module at https://dhsprogram.com/pubs/pdf/DHSQMP/DHS5_Module_Female_Genital_Cutting.pdf}
...
% \cfcmt{the structure:  cultural and legal background; comparison of our findings to previous studies; implications}
...
%\cfcmt{a sentence on the national FGC policy of the 4 nations and gender law}
...
and their position on continuing FGC in the future (also normative norm?)  It is called FGC future model.  Second, what is the association of woman's beliefs in FGC benefits and their daughters' FGC status %\cfcmt{empirical norm?}? 
