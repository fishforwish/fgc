...
Female genital cutting (FGC), circumcision or mutilation is mostly defined as violating human rights \cite{WHO97, WHO08} \cfonly{add and update}.  The commonly shared position of FGC is about abolishment than intervention of the practice \cite{KhosBane17, Mack96, Toub94, UNIC16, WHO97}.  It is estimated, based on a UNICEF global database \cite{AdnrLesc16, UNIC16} \cfcmt{I think we can delete these: including Demographic and Health Surveys (DHS), Multiple Indicator Cluster Surveys (MICS), and other nationally representative surveys} between 2004 to 2015, that more than 200 million women and girls have undergone female genital cutting (FGC), mostly in Africa and the Middle East, and among them, 44 million are girls below age 15.  It was also foreseen that another 15 million girls and women are at risk by 2020  \cite{AdnrLesc16, UNIC16}.  Progress of intervention is hindered because of the complicated history \cite{BergDeni12, Cami16} and of not keeping up with the population growth \cite{KhosBane17, UNIC16}.  Following Tostan \cite{Tost15}, we used cutting instead of circumcision without demising or excusing the negative impact of the practice while recognizing a sense of self-awareness in FAC decision\cite{KhahBark09, JohnEsse10, Meye00, PariSaru18, Shel01, Tost15}. \cfonly{less cites}

FGC is embodied with multiple perspectives from cultural and religious identity in one end and public health and human rights concerns on the other} \cite{AhmeKare18, BergDeni13a, Boyl02, BoylMcMo02, Grue01, KhosBane17, KimaShell18, McCh15, SchuLien13, WHO12}. \cfonly{too many cites}.  Understanding reasons and values people attached to FGC is essential to comprehend the persistence of the practice \cite{Bicc10, CislHeis18, Mack96} for any negotiation and to reduce possible harmful intervention \cite{Cami15}.  Social norm, a form of values driving behavioural patterns which are self-enforcing within a group \cite{Youn15}; it can refer to an average outcome or a common practice \cite{MillPrin16}.   Social norms is widely applied in understanding public health behaviours \cite{Ajze91, Ajze02, CislHeis18a, MillPrin16, MollRima10, RimaLapi15}, provides a crucial venue in negotiating sustainable changes of FGC practice \cite{Bicc10, BiccMari15, BoylCorl010, DuncWand11, Drol11, EffeVogt15, Hayf05, HayfTrin11, Grue05, Hodg11,KandNwak09, Mack96, Mack00, MackLeJe08, OdukAfol17, RimaLapi15, Youn02, Youn11, UNIC10, UNIC13} \cfonly{less}. 

FGC values and norms tended to be deeply internalized and morally embraced \cite{SchuLien13}.  Social convention theory, a leading theory (e.g., \cite{BoylMcMo02, BoylCorl10, FreyJohn07, FrieMahm13, Hayf05, KandMwek09, Mack96, Mack06, ReigGonz14, YirgKass12}) utilizing normative behavior in FGC research \cite{Hayf05, ShelWand11} \cfonly{more} proposed that FGC was a marriageability convention and extending to, latter, a social norm, such as religious obligation, adolescent rite of passage, and female honour and modesty to control marriage fidelity and social prestige \cite{Mack00, MackLeJe08}.   FGC was furthered deemed as a form of social capital, a value expected by women for inclusion within their social groups \cite{ShelWand11}. The social convention theory regards FGC a social behaviour interdependent among and coordinated by members in their social network \cite{Mack00, MackLeJe08, ShelWand11}.  Social expectation (i.e., what other people do or what other people believe one should do) was strongly correlated with FGC practice \cite{BiccMari15}.  Basically, when the norms within the communities are strong, individuals tend to self-enforce community norms \cite{Ajze02, Hayf05, KandNwak09, KandShel19, Mack96, Mack06, MackLeJe08, ThomMadd92} \cfonly{add \cite{Bicc15}}.  


======The planned behaviour \cite{}.  For example, there was no coordination game observed in marital expectation \cite{EffeVogt15} and it was a peer convention for inclusion instead of for marriageability \cite{ShelWand11}.   It was also argued that anti-FGC discourse perpetuated a colonial assumption by universalizing a western view of normal body and sexuality \cite{Njam04}.  Studies showed that factors other than marriageability have underlined women’s  decisions of FGC \cite{AlcaGonz13, BellNova15, EffeVogt15, Hayf05, Mack09, PashPonn16, Rima08, ShelWand11, more?}.  =====

In this study, we consider multiple social determinants of FGC practice both at an individual and a community level to analyze how FGC norm at a community level associates with that at an individual level in predicting the persistence of FGC practice \cfcmt{in the presumption that attitudes is a good proxy of social norm \cite{}}.  \cfonly {norm theory \cite{Ajze91, Ajze02, Bicc10, BiccMari15, Mack96, Mack00, MackLeJe08, RimaLapi15, Youn11} applied on fgc \icte{CislHeis18, EffeVogt15, Harf06, ModrLiu13 , PashPonn16, ShelHern06,}}  

\subsection{Research Questions}\label{research-questions}

\jdcmt{Think about a good \P\ structure here (and topic ss).}
This study takes both the dynamics of beliefs of FGC benefits and of FGC practices into account at both a population and a community level to understand associations of FGC values and intention of carrying out the practices.  Our main interest in this study is to analyze how norms associate with behavioural intention.  We focus on whether women will likely genitally cut their daughters based on their current intention and that provides a relatively more detailed result on how FGC norms interacts FGC practice than using than what had already happened (e.g. women’s own FGC status).  The main norm theory tested in this paper was that women’s intention on practicing FGC on their daughters was dependent on other women’s intention on cutting their daughters within their community.  We developed three models in this study.  The main one is the “daughter” model, which analyzed associations of beliefs of FGC benefits (see the list of FGC benefits at table xx) and intention to have their daughters undergoing FGC in order to understand if patterns of social norms (i.e., aggregation of values of FGC benefits) associating behavioral intention can be detected.  Additionally, we also decompose the model into two “structural” models:  “persistence” model to study women’s beliefs of FGC benefits and FGC continuance; and “daughter persistence” model to examine the association of beliefs of FGC benefits, FGC persistence and intention of genitally cutting daughters to understand how such positions change the main model.

\jdcmt{Do we really call our three models: daughter; persistence; and daughter persistence? It does not seem conducive to reader understanding.} \cfcmt{That was what we agreed.  We don’t really like the names but couldn’t come up with a better one. How about daughter, fgc continuity, and structural mixed model?}
...
We conducted secondary analysis of women aged 15-49 in the Demographic and Health Surveys (DHS) with FGC benefit and gender awareness modules in countries with high FGC prevalence \cite{UNIC16}. We found four countries, and used the most recent complete data set from each: Kenya 2008/9, Mali 2006, Nigeria 2008 and Sierra Leone 2008.  \jdcmt{these are pretty old.} \cfcmt{checked in 1/09/19.  Yes.  Those datasets are pretty old but were the most recent ones with fgc benefits modules.}.

\jdcmt{Never use underscores without the url command; it messes up formatting.}
