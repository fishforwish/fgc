...
Baseline sociodemographic and sample characteristics are shown in figure x.  The prevalence of FGC were 31.8\%, 45.9\%, 88.6\% and 91.0\%, intention to have their daughters cut 12.3\%, 7.9\%, 47\% and 80.4\%, and supporting FGC practice in the future 15.5\%, 20.6\%, 73.9\% and 65.5\% in Kenya, Nigeria, Mali and Sierra Leon accordingly.  The results showed patterns that the higher FGC prevalence is, the more likely mothers will have their daughters undergoing FGC and more likely to support FGC practice in the future.  

\cfml{sample size of daughters plan in sociodemographic figure?  It should be only the women with daughters for fgc.}

The results of the three models are at figure xxx \cf{isoplots and effect plots}.  The findings showed robust results.  The main predictors, women’s fgc status, beliefs of fgc benefits and FGC prevalence were all clearly and positively associated with the two responses (intention to cut daughters and attitudes on whether FGC should be continued) in all the three models; so as the following factors but in negative associations:  age, education, media, religion and the community levels of beliefs of FGC benefits \cf{this one is tricky to interpret}.  In addition, group level of intention to cut daughters was also clearly and positively associated with mothers’ intention to cut their daughter, as well as group persistence of FGC practice with the women’s attitudes on FGC practice.   Although gender awareness was positively associated with both responses but only at an individual level not a group level.

Basically, our main models indicated that mothers’ intention of having their daughters cut was mostly associated with the group intention on this matter (see Fig x daughterPlan_effects_plot.Rout.pdf and iso plots) \cf{group_daughterPlan  142.11  1  < 2.2e-16.  How to transfer this into a more understandable sentence?}:  the stronger the intention of cutting daughters within their group, the more likely a mother’s intention to cut their daughters.  Similarly in the persistent model (see persistence effect plots and iso plots), the higher the attitudes on carrying on FGC practice within a group, the more likely a mother’s attitude on supporting such a practice.  Both models also showed that women’s beliefs in FGC benefits and their FGC status positively related to their likelihood of cutting their daughters, and supporting the practice.
...
Based on the findings, we believed that FGC is a coordinated social norm \cite{Makie etc}:  an individual behavioral intention is subjected to their community’s normative ritual.  The norm of FGC is synergistic, based on what women think about other women’s likely position in their community regarding the practice (i.e., likelihood of others to cut their daughters) AND values they attached to this practice (i.e., beliefs of FGC benefits).  Our findings indicated that the likelihood of whether a mother will cut their daughters was overdetermined by her community’s overall likelihood of mothers’ intention to cut their daughters and the mother’s personal beliefs of FGC benefits more so than by her fgc status and the community’s FGC prevalence (see daughrer isoplot x and effect plots x).   The similar coordination was also applied to supporting FGC practice in the future.  Based on the robust findings, we believe that FGC was an act of coordination \cite{} and supported by social values and beliefs within the community \cite{BiccMari15}.  The coordinated performance could (or would be?) be a result of subjective norm as perceived social pressure to perform such behaviour or expected choice of conduct \cite{Ajze91}. \cfonly{FGC is less a coordination rite than singling group identity and symbolism \cite{ShelWand11, Youn15}} \cf{But what is this coordination based on if not marriageability?  What can we find from the benefits PCAs?}

Although FGC prevalence in a community was deemed as a main factor predicting daughter’s FGC status \cite{BoylSvec19} \cf{more cites}, our results found that community intention of cutting daughters is a greater factor cf{ show daughter effect plot}.  The findings suggested that community preference (What kind of norm? subjective vs. objective? ) carries more force on mothers’ intention on cutting their daughters:  What their community members will do is likely to determine what a mother will do to their daughters’ FGC status. In this case, what people did (descriptive norm?) was less a force than what they will do (subjective norm?). \cf{One confusing finding is that all the three models showed group fgc benefits are robustly and negatively associated with the responses.}.  Norms sustained through communications and evolve through social interactions \cite{FishAjze10, RimaLapi15}. 

In the findings, community beliefs of FGC benefits had a negative correlation with both women’s intention of cutting their daughters and FGC continuance:  when the more and stronger FGC benefits were, the less likely a mother to cut their daughters and less likely to support the practice.  This was against common wisdom \cite{}.  ”The explanation of community belief is that it's left over after we include community behaviour. If the community believes in it, they'll probably do it, and then I'll probably do it. But if I_control for_ community behaviour, there's no reason to think that community belief is still explanatory. In fact, if I see myself as different from the community I'm more likely to break the norm than if I don’t.” \cfjd{J:  This is basically your quote.  Can you rewrite it?  And I don’t understand the last sentence.} 


\cfonly{Rimale et ’15:  sum of benefits does not equal norm}
- conventional \cite{FreyJohn07, Hayf05, KandShel19, Mack96, ShelWand11} vs. 
- \cite{PashPonn16}:  “attitude is the strongest predictor of mothers' intentions to allow their daughters to undergo FGM, followed by subjective norms." also their findings showed that beliefs of fgc benefits was the strongest predictor of mother’ intention of cutting daughters.
\cite{ShelWand11}:“alternative convention/peer convention.
...
What does it mean that group level of daughter future as the biggest predictor compared to individual benefit and group fgc (prevalence)?   Is it a social norm supported by social sanction (i.e., cutting daughter) for what reason? (see \cite{MackLeJe08} (p.28 which mentioned Bicchieri06)
...
Based on our findings that education (individual and community), wealth (individual and community), community gender awareness and job did not predict women’s intention on cutting their daughters, we proposed that modernization \cite{BoylMcMo02, Youn02} and gender perspectives \cite{BoylSvec19, DalaLawo10, Dell04, FrieMahm13, Lewi04, Meye00, Njam04, YirgKass12, Youn02} were less a forceful intervention of FGC convention \cite{Hayf05} \cfonly{to confirm}.
...
%\cite{Hayf05}: Some research showed that household wealth has nonlinear correlation with women's FGC status predictor of daughter's FGC status
