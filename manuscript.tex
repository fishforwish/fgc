...
It was estimated that more than 200 million women, of which 44 millions were girls under age 15, \jd{This ratio seems super-low. I would expect a majority under 15, no?}\cf{Most of the surveys sampled women of 15-49, girls under 15  were reported by their mothers. The ration of girls under 15 is minority} have undergone female genital cutting (FGC), mostly observed in Africa and the Middle East \cite{UNFPA14, UNIC16} (updated Sep 18).  The current progress of ending FGC is insufficient to keep up with the population growth, and girls and women undergoing FGC will rise significantly over the next 15 years if the trends continue \cite{UNIC16} (also see http://www.who.int/mediacentre/factsheets/fs241/en/ updated Sep, 18) \jd{This claim is surprising, and the sources are not academic.}\cf{UN is supposed to be reliable and often quoted by academic papers}.  FGC is also known as female genital mutilation and female circumcision; we use cutting instead because it \jd{What: implies a degree of self-awareness and} is considered less judgmental \cite{KhahBark09, JohnEsse10, Meye00, Shel01} (and is adapted by Tostan (http://www.tostan.org/)).
