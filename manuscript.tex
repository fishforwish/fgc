...
It is estimated, based on a UNICEF global database \cite{AdnrLesc16, UNIC16} \cfcmt{I think we can delete these: including Demographic and Health Surveys (DHS), Multiple Indicator Cluster Surveys (MICS), and other nationally representative surveys} between 2004 to 2015, that more than 200 million women and girls have undergone female genital cutting (FGC), mostly in Africa and the Middle East, and among them, 44 million are girls below age 15.  It was also foreseen that another 15 million girls and women are at risk by 2020  \cite{AdnrLesc16, UNIC16}.  Progress in reducing FGC is not keeping up with the population growth: the number of girls and women undergoing FGC is projected to rise significantly over the next decade if current trends continue \cite{KhosBane17, UNIC16}.  Following Tostan \cite{Tost15}, we used cutting instead of circumcision without demising or excusing the negative impact of the practice while recognizing a sense of self-awareness \cite{KhahBark09, JohnEsse10, Meye00, PariSaru18, Shel01, Tost15}. \cfonly{less cites}

In most part of the world, FGC is defined as violating human rights \cite{WHO97, WHO08} \cfonly{add and update}.  The commonly shared position of FGC is about to abolish than to intervene the practice \cite{KhosBane17, Mack96, Toub94, UNIC16, WHO97}.  Yet, the progress of intervention is hindered due to the complicated history \cite{BergDeni12, Cami16}.  FGC is embodied with multiple meanings with cultural and religious identity in one end and public health and human rights concerns on the other} \cite{AhmeKare18, BergDeni13a, Boyl02, BoylMcMo02, Grue01, KhosBane17, KimaShell18, SchuLien13, WHO12}. \cfonly{too many cites}.  Understanding values and meanings attached to FGC is essential to comprehend the persistence of FGC practice \cite{}.  Social norm, as behavioural patterns that are self-enforcing within a group \cite{Youn15} and widely applied in understanding public health behaviours \cite{Ajze91, Ajze02, CislHeis18a,MollRima10, RimaLapi15}, is is crucial in intervention of sustainable changes \cite{Bicc10, BiccMari15, BoylCorl010, DuncWand11, Drol11, EffeVogt15, Hayf05, HayfTrin11, Grue05, Hodg11,KandNwak09, Mack96, Mack00, MackLeJe08, OdukAfol17, RimaLapi15, Youn02, Youn11, UNIC10, UNIC13} \cfonly{less}.

Convention theory, a widely regarded approach in FGC norm research, posited first that FGC was a marriageability convention and, latter on, a social norm and others, such as religious obligation, adolescent rite of passage, and female honour and modesty as an important norm to control marriage fidelity and social prestige \cite{Mack00, MackLeJe08}.  The convention theory views FGC as a social behaviour resulting from group coordination \cite{Mack00, MackLeJe08}.  FGC was also viewed as a social capital, a value expected by women for inclusion within women’s social groups \cite{ShelWand11}. Basically, when the norms within the communities are strong, individuals tend to self-enforce community norms \cite{Ajze02, Hayf05, KandNwak09, KandShel19, Mack96, Mack06, MackLeJe08, ThomMadd92} and the bond within women's social networks could be interdependent and interconnected across generations  \cite{Mack00, ShelWand11}. \cfonly{add \cite{Bicc15}}.  Although normative behaviour based on convention theory was well documented regarding analysis of persistence of FGC practices (e.g, \cite{BoylMcMo02, BoylCorl10, FreyJohn07, FrieMahm13, Hayf05, KandMwek09, Mack96, Mack06, ReigGonz14, YirgKass12}), it was not without challenges \cite{EffeVogt15, Njam04}.  For example, there was no coordination game observed in marital expectation \cite{EffeVogt15}.  it was also argued that anti-FGC discourse perpetuated a colonial assumption by universalizing a western view of normal body and sexuality \cite{Njam04}.  Studies showed that factors other than marriageability have underlined women’s fgc decisions \cite{AlcaGonz13, BellNova15, EffeVogt15, Hayf05, Mack09, PashPonn16, Rima08, ShelWand11, more?}.  

Multiple theoretical frameworks were \jdcmt{what does this mean; called to be incorporated to grasp a full explanation} of the persistence and decline of FGC due to the heterogeneity of the population \cite{EffeVogt15, ModrLiu13} \cfonly {norm theory \cite{Ajze91, Ajze02, Bicc10, BiccMari15, Mack96, Mack00, MackLeJe08, RimaLapi15, Youn11} applied on fgc \icte{CislHeis18, EffeVogt15, Harf06, PashPonn16, ShelHern06,}}  In this study, we consider multiple social determinants of FGC practice both at a individual and a community level to analyze how community of FGC expectation and beliefs associates with individual attitudes on the practice.  In addition to \jdcmt{hard to figure out what this means in this context, do you just mean attitudes about FGC? social norms of FGC,} we also incorporated information about women’s gender values and their \jdcmt{Can you explain this? social environment.}
...
\jdcmt{Do we really call our three models: daughter; persistence; and daughter persistence? It does not seem conducive to reader understanding.}

\subsection{Methods}\label{methods}

\subsubsection{Data and Samples}\label{data-and-samples}

\jd{What is added by ``and samples'' here?}

We conducted secondary analysis of women aged 15-49 in the Demographic and Health Surveys (DHS).  We selected countries with: high FGC prevalence \cite{UNIC16}, and FGC benefit and gender awareness modules available from DHS. We found four countries, and used the most recent complete data set from each: Kenya 2008/9, Mali 2006, Nigeria 2008 and Sierra Leone 2008.  We did not analyze the newest dataset \jdcmt{What data set did we not analyze? Can we just say we analyzed the newest available (see edits above)? Also: these are pretty old.} due to the lack of FGC benefits modules before this study finished for publication \cf{checked in 1/09/19}.
